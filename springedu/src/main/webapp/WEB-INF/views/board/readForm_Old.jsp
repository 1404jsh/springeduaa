...
<!-- 읽기모드 -->
						<li class="btnGrp rmode">
							<form:button type="button" id="relpyBtn"
											class="btn btn-outline-success">답글
							</form:button>
							<form:button type="button" id="modifyBtn"
											class="btn btn-outline-danger">수정
							</form:button>
						...
						<!-- 수정모드 -->
							...
							<form:button type="button" id="svaeBtn"
											class="btn btn-outline-success">저장
							</form:button>
							<form:button type="button" id="listBtn"
											class="btn btn-outline-warning">목록
							</form:button>
